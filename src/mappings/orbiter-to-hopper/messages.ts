...
export const messages = {
  todoComments: {
    ...
    card_significant_changes: "The `Card` component has significant changes. You can use this provided `OrbiterCard` shim to make it work: https://github.com/workleap/wl-design-systems-migrations/blob/main/src/mappings/orbiter-to-hopper/shims/OrbiterCard.tsx",
    ...
    disclosure_manual_migration: "Automatic migration is not possible. Please do it manually by adding slot=`trigger` to the trigger and replace the content tag with `DisclosurePanel` component. More details: https://hopper.workleap.design/components/Disclosure#usage-custom-header",
    ...
    transition_not_supported: "`Transition` is not supported anymore. You can use The provided `Transition` shim instead: https://github.com/workleap/wl-design-systems-migrations/blob/main/src/mappings/orbiter-to-hopper/shims/Transition.tsx"
  },
  migrationNotes: {
    counter_not_supported: "`Counter` is not supported anymore. You need to find an alternative. You can see this as an example:https://dev.azure.com/sharegate/ShareGate.Protect.Web/_git/ShareGate.Protect.Web/commit/8c969df4da52b1a0208d54e295762f36aa364ce4?path=/apps/tenant-assessment/src/pages/sharing-links.%5BworkspaceId%5D.tsx&version=GBmain&line=83&lineEnd=89&lineStartColumn=1&lineEndColumn=1&type=2&lineStyle=plain&_a=files",
    dot_not_supported: "`Dot` is not supported anymore. Find an alternative. One possible option: `<Badge isIndeterminate />`",
